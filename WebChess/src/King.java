...
public class King extends Piece{
	...
	public ArrayList<Square> possibleMoves(Board board){
		...
		//haut
		if (this.getHeigth()!=8){
			if (board.isEchec(echecList, this.getHeigth()+1, this.getWidth())){
		...
		//gauche
		if (this.getWidth()!=1){
			if (board.isEchec(echecList, this.getHeigth(), this.getWidth()-1)){
		...
		if (this.getHeigth()!=8 && this.getWidth()!=8){
			if (board.isEchec(echecList, this.getHeigth()+1, this.getWidth()+1)){
